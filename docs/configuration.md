...
| LIGHTER_STATE_RETAIN_INTERVAL          | `java.time.Duration` representing how long finished session and batch history will be retained before automatic cleanup.                                                                                 | 10m                             |
